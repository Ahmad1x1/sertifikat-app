...
export const CLOSING_PARAGRAPH: Record<Role, string> = {
  Pemateri:
    "Semoga ilmu dan pengalaman yang dibagikan menjadi amal jariyah, memberikan manfaat bagi peningkatan kualitas pendidikan, serta mendapat ridha dari Allah Subḥānahu wa Ta'älä.",
  Peserta:
    "Semoga ilmu dan pengalaman yang diperoleh menjadi bekal yang bermanfaat, memberikan kontribusi bagi peningkatan kualitas pembelajaran, serta mendapat ridha dari Allah Subḥānahu wa Ta'älä.",
};
