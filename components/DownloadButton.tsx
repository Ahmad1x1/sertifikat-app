...
export default function DownloadButton({ event, recipient, certNumber }: Props) {
  ...
  return (
    <>
      ...
      <div
        style={{ position: "fixed", top: 0, left: -99999, width: DESIGN_WIDTH, height: DESIGN_HEIGHT, pointerEvents: "none" }}
        aria-hidden="true"
      >
        <Certificate innerRef={hiddenRef} event={event} recipient={recipient} certNumber={certNumber} />
      </div>
    </>
  );
}
